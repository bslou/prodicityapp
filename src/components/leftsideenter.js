    ...
    return (
        <Flex direction={'column'} alignItems = {'center'} justifyContent = {'center'} height={'100vh'} width={'40vw'} marginBottom = {'10vw'}>
            ...
            <Flex direction={'row'} justifyContent = {'center'} alignItems = {'center'} marginTop={'3vw'}>
                <Link color={'black'} border={'1px solid black'} fontSize= {'1.4vw'} paddingTop={'1.2vw'} paddingBottom={'1.2vw'} paddingLeft={'2.5vw'} paddingRight={'2.5vw'} backgroundColor = {'transparent'} borderTopLeftRadius = {20} borderTopRightRadius = {0} borderBottomLeftRadius = {20} borderBottomRightRadius = {0}>
                Login
                </Link>
